...
const ACTION_MATCHERS: Record<string, string[]> = {
  ...
  edit_task: ['edit', 'save changes', 'assign'],
  complete_task: ['start', 'complete', 'close'],
  reopen_task: ['reopen'],
  delete_task: ['delete'],
  ...
  manage_geofence: ['manage geofence', 'attendance settings'],
  create_mom_entry: ['new mom', 'save mom'],
  convert_to_malayalam: ['convert to malayalam'],
  edit_mom: ['edit mom'],
  export_mom_history: ['download pdf', 'download'],
  create_booking: ['new booking', 'create booking', 'confirm booking'],
  edit_booking: ['edit', 'save changes'],
  cancel_booking: ['cancel booking'],
  add_payment: ['add payment', 'record payment', 'pay', 'submit payment'],
};
