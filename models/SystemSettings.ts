...
export const DEFAULT_SETTINGS = [
  ...
  { key: 'invoice_signature', value: '', label: 'Invoice Authorized Signature Base64', category: 'general' },
  { key: 'invoice_bank_name', value: '', label: 'Invoice Bank Name & Branch', category: 'general' },
  { key: 'invoice_account_no', value: '', label: 'Invoice Account Number', category: 'general' },
  { key: 'invoice_ifsc_code', value: '', label: 'Invoice IFSC Code', category: 'general' },
  { key: 'invoice_account_holder', value: '', label: 'Invoice Account Holder Name', category: 'general' },
  { key: 'invoice_qr_code', value: '', label: 'Invoice Payment QR Code (Base64)', category: 'general' },
  ...
  { key: 'turf_weekend_rules', value: [], label: 'Turf Weekend Price Customization', category: 'bookings' },
  { key: 'nets_machine_weekday_rules', value: [], label: 'Nets (With Machine) Weekday Price Customization', category: 'bookings' },
  { key: 'nets_machine_weekend_rules', value: [], label: 'Nets (With Machine) Weekend Price Customization', category: 'bookings' },
  { key: 'nets_nomachine_weekday_rules', value: [], label: 'Nets (Without Machine) Weekday Price Customization', category: 'bookings' },
  { key: 'nets_nomachine_weekend_rules', value: [], label: 'Nets (Without Machine) Weekend Price Customization', category: 'bookings' },
  { key: 'lounge_hourly_rate', value: 0, label: 'Lounge Hourly Rate', category: 'bookings' },
  { key: 'turf_holidays', value: [], label: 'Turf Holiday Customization', category: 'bookings' },
  { key: 'nets_machine_holidays', value: [], label: 'Nets (With Machine) Holiday Customization', category: 'bookings' },
  { key: 'nets_nomachine_holidays', value: [], label: 'Nets (Without Machine) Holiday Customization', category: 'bookings' },
