...
const navItems = [
  ...
  { label: 'Sales', href: '/superadmin/sales/manage', icon: <ShoppingCart size={20} /> },
  { label: 'Inventory', href: '/superadmin/inventory', icon: <Package size={20} /> },
  { label: 'Cash In Hand', href: '/superadmin/cash-assignment', icon: <Banknote size={20} /> },
  { label: 'Checklists', href: '/superadmin/checklists', icon: <CheckSquare size={20} /> },
  { label: 'Meeting of Minutes', href: '/superadmin/mom', icon: <FileText size={20} /> },
